...
{
    public function __construct(MySqlConnection $connection, string $sql)
    {
    ...
    public function executeReader(array $parameters = []): MySqlReader
    {
        if ($this->connection->State == 0) {
            throw new \PDOException('Database connection is closed');
        }
        ...
        return new MySqlReader($this, $statement);
    }
}
